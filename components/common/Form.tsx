  ...
  return (
    ...
    >
      ...
      <div className="w-full h-fit bg-white mb-9">
        ...
        {errors.name && (
          <small className="text-rose-600">
            Por favor ingrese los valores correctos (hasta 35 caracteres)
          </small>
        )}
      </div>
      <div className="w-full h-fit bg-white mb-9">
        ...
        {errors.lab && (
          <small className="text-rose-600">
            Por favor ingrese los valores correctos
          </small>
        )}
      </div>
      <div className="w-full h-fit bg-white  mb-9">
        ...
        {errors.phone && (
          <small className="text-rose-600">
            Por favor ingrese los valores correctos (8 números sin espacio)
          </small>
        )}
      </div>
      <div className="w-full h-fit bg-white mb-9">
      ...
      <div className="w-full h-fit bg-white mb-9">
        ...
        {errors.message && (
          <small className="text-rose-600">
            Por favor ingrese los valores correctos (hasta 240 caracteres)
          </small>
        )}
      </div>
      <button
        type="submit"
        className="py-3 bg-duo-orange w-full border border-duo-orange rounded-lg text-2xl text-white"
      >
        Enviar
      </button>
    </form>
